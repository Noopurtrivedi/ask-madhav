...
| `components/darshan/three/KrishnaFigure.tsx` | **The 3D Krishna avatar** — a stylised figure built from geometry: tribhanga stance, mukuta crown, three mor pankh, flute (Venugopala pose), lotus pedestal, aura + halo, key/rim/fill rig. Faceless by the safety constraint; recognisable by silhouette. Placeholder until a commissioned GLB (docs/ASSETS.md). |
